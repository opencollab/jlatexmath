	...
	protected final void initMetrics() {
		...
		setInfo('\u0390', // char code: 912
				new double[] { 0.25, 0.701, 0.012, 0. }, // metrics: width,
															...
															// italic
				null, // ligatures
				new char[] { '\u03B3', '\u03B7', '\u03B8', '\u03BD', '\u03BF', '\u03C2', '\u03C3', '\u03C4', '\u03C7',
						'\u03D1' }, // kern codes
				new double[] { -0.028, -0.017, -0.017, -0.056, -0.028, -0.028, -0.028, -0.028, -0.028, -0.017 }, // kern
																													// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u0391', // char code: 913
				new double[] { 0.75, 0.717, 0., 0. }, // metrics: width, height,
														// depth, italic
				null, // ligatures
				new char[] { '\u0398', '\u039F', '\u03A4', '\u03A5', '\u03A6', '\u03A8', '\u03AB' }, // kern
																										// codes
				new double[] { -0.083, -0.083, -0.083, -0.139, -0.083, -0.122, -0.139 }, // kern
																							// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03AF', // char code: 943
				...
				new char[] { '\u03B3', '\u03B7', '\u03B8', '\u03BD', '\u03BF', '\u03C2', '\u03C3', '\u03C4', '\u03C7',
						'\u03D1' }, // kern codes
				new double[] { -0.028, -0.017, -0.028, -0.056, -0.028, -0.028, -0.028, -0.028, -0.028, -0.017 }, // kern
																													// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03C4', // char code: 964
				new double[] { 0.458, 0.432, 0.01, 0. }, // metrics: width,
															...
															// italic
				null, // ligatures
				new char[] { '\u03AC', '\u03B1', '\u03BF', '\u03C9', '\u03CC', '\u03CE', '\u1F00', '\u1F01', '\u1F04',
						'\u1F05', '\u1F06', '\u1F07', '\u1F40', '\u1F41', '\u1F44', '\u1F45', '\u1F60', '\u1F61',
						'\u1F64', '\u1F65', '\u1F66', '\u1F67', '\u1F70', '\u1F78', '\u1F7C', '\u1F80', '\u1F81',
						'\u1F84', '\u1F85', '\u1F86', '\u1F87', '\u1FA0', '\u1FA1', '\u1FA4', '\u1FA5', '\u1FA6',
						'\u1FA7', '\u1FB2', '\u1FB4', '\u1FB6', '\u1FB7', '\u1FF2', '\u1FF4', '\u1FF6', '\u1FF7' }, // kern
																													// codes
				new double[] { -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028,
						-0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028,
						-0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028,
						-0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028 }, // kern
																											// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
