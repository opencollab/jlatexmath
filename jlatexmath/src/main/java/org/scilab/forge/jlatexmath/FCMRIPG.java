	...
	protected final void initMetrics() {
		...
		setInfo('\u0390', // char code: 912
				new double[] { 0.25, 0.702, 0.011, 0.13 }, // metrics: width,
															...
															// italic
				null, // ligatures
				new char[] { '\u03B3', '\u03B7', '\u03B8', '\u03BA', '\u03BD', '\u03BF', '\u03C2', '\u03C3', '\u03C4',
						'\u03C7', '\u03CC', '\u03E1', '\u1F40', '\u1F41', '\u1F44', '\u1F45', '\u1F78' }, // kern
																											// codes
				new double[] { -0.069, -0.017, -0.033, -0.056, -0.056, -0.028, -0.028, -0.028, -0.083, -0.056, -0.028,
						-0.167, -0.028, -0.028, -0.028, -0.028, -0.028 }, // kern
																			// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u0391', // char code: 913
				new double[] { 0.75, 0.717, 0., 0. }, // metrics: width, height,
														// depth, italic
				null, // ligatures
				new char[] { '\u0398', '\u039F', '\u03A4', '\u03A5', '\u03A6', '\u03A8', '\u03AB', '\u03BD' }, // kern
																												// codes
				new double[] { -0.083, -0.083, -0.083, -0.139, -0.083, -0.122, -0.139, -0.097 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03AC', // char code: 940
				new double[] { 0.555, 0.702, 0.011, 0. }, // metrics: width,
															...
															// italic
				null, // ligatures
				new char[] { '\u03B3', '\u03B8', '\u03BD', '\u03BF', '\u03C0', '\u03C4', '\u03C5', '\u03C7', '\u03C8',
						'\u03CC', '\u03CD', '\u1F78', '\u1F7A' }, // kern codes
				new double[] { -0.083, -0.083, -0.083, -0.028, -0.044, -0.083, -0.083, -0.083, -0.028, -0.028, -0.083,
						-0.028, -0.083 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03AD', // char code: 941
				new double[] { 0.389, 0.702, 0.011, 0.067 }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u03AC', '\u03B1', '\u03B4', '\u03C3', '\u03C5', '\u03C7', '\u03CD', '\u03E1', '\u1F70',
						'\u1F7A', '\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6', '\u1FB7', '\u1FE6' }, // kern
																								// codes
				new double[] { -0.028, -0.028, -0.028, -0.028, -0.028, -0.008, -0.028, -0.167, -0.028, -0.028, -0.028,
						-0.028, -0.028, -0.028, -0.028, -0.028 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03B1', // char code: 945
				...
				new char[] { '\u03B3', '\u03B8', '\u03BD', '\u03BF', '\u03C0', '\u03C4', '\u03C5', '\u03C7', '\u03C8',
						'\u03CC', '\u03CD', '\u03E1', '\u1F50', '\u1F52', '\u1F54', '\u1F55', '\u1F56', '\u1F57',
						'\u1F78', '\u1F7A', '\u1FE6' }, // kern codes
				new double[] { -0.083, -0.083, -0.094, -0.028, -0.044, -0.083, -0.083, -0.083, -0.028, -0.028, -0.083,
						-0.222, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.028, -0.083, -0.083 }, // kern
																											// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03B2', // char code: 946
				new double[] { 0.444, 0.707, 0.212, 0.093 }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u03AD', '\u03AF', '\u03B5', '\u03B9', '\u03BF', '\u03C4', '\u03C6', '\u03C7', '\u03C8',
						'\u03CC', '\u03E1', '\u1F72', '\u1F76', '\u1F78', '\u1FD6' }, // kern
																						// codes
				new double[] { 0.028, 0.028, 0.028, 0.028, 0.028, 0.028, 0.028, -0.028, 0.056, 0.028, -0.056, 0.028,
		...
		setInfo('\u03B4', // char code: 948
				new double[] { 0.467, 0.707, 0.01, 0.033 }, // metrics: width,
															...
															// italic
				null, // ligatures
				new char[] { '\u03AC', '\u03B1', '\u03B3', '\u03BC', '\u03BD', '\u03C0', '\u03C5', '\u03C7', '\u03CD',
						'\u03E1', '\u1F70', '\u1F7A', '\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6', '\u1FB7', '\u1FE6' }, // kern
																													// codes
				new double[] { -0.028, -0.028, -0.083, -0.044, -0.039, -0.028, -0.028, -0.017, -0.028, -0.167, -0.028,
						-0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028 }, // kern
																					// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03B6', // char code: 950
				new double[] { 0.417, 0.696, 0.156, 0.082 }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u03AC', '\u03AD', '\u03AE', '\u03B1', '\u03B3', '\u03B4', '\u03B5', '\u03B7', '\u03B8',
						'\u03BC', '\u03BD', '\u03BF', '\u03C0', '\u03C3', '\u03C4', '\u03C5', '\u03C6', '\u03C7',
						'\u03C8', '\u03C9', '\u03CC', '\u03CD', '\u03CE', '\u03E1', '\u1F70', '\u1F72', '\u1F74',
						'\u1F78', '\u1F7A', '\u1F7C', '\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6', '\u1FB7', '\u1FC2',
						'\u1FC3', '\u1FC4', '\u1FC6', '\u1FC7', '\u1FE6', '\u1FF2', '\u1FF3', '\u1FF4', '\u1FF6',
						'\u1FF7' }, // kern codes
				new double[] { -0.083, -0.083, -0.083, -0.083, -0.111, -0.056, -0.083, -0.083, -0.056, -0.056, -0.089,
						-0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.028, -0.083, -0.083, -0.083, -0.083,
						-0.056, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083,
						-0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083, -0.083 }, // kern
																													// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03B8', // char code: 952
				new double[] { 0.514, 0.707, 0.011, 0.065 }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u03AD', '\u03AF', '\u03B5', '\u03B9', '\u03C8', '\u03E1', '\u1F72', '\u1F76', '\u1FD6' }, // kern
																															// codes
				new double[] { 0.028, 0.028, 0.028, 0.028, 0.028, -0.056, 0.028, 0.028, 0.028 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03BB', // char code: 955
				new double[] { 0.45, 0.707, 0.011, 0.011 }, // metrics: width,
															...
															// italic
				null, // ligatures
				new char[] { '\u03AC', '\u03B1', '\u03B3', '\u03B8', '\u03BC', '\u03BD', '\u03C3', '\u03C4', '\u03C5',
						'\u03C7', '\u03CD', '\u03E1', '\u1F70', '\u1F7A', '\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6',
						'\u1FB7', '\u1FE6' }, // kern codes
				new double[] { -0.014, -0.014, -0.139, -0.044, 0.014, -0.083, -0.028, -0.028, -0.056, -0.056, -0.056,
						-0.167, -0.014, -0.056, -0.014, -0.014, -0.014, -0.014, -0.014, -0.056 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03BC', // char code: 956
				new double[] { 0.5, 0.432, 0.222, 0.002 }, // metrics: width,
															...
															// italic
				null, // ligatures
				new char[] { '\u03AC', '\u03B1', '\u03B3', '\u03B6', '\u03B8', '\u03BD', '\u03BF', '\u03C0', '\u03C3',
						'\u03C5', '\u03C6', '\u03C7', '\u03C9', '\u03CC', '\u03CD', '\u03CE', '\u03E1', '\u1F70',
						'\u1F78', '\u1F7A', '\u1F7C', '\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6', '\u1FB7', '\u1FE6',
						'\u1FF2', '\u1FF3', '\u1FF4', '\u1FF6', '\u1FF7' }, // kern
																			// codes
				new double[] { -0.056, -0.056, -0.083, -0.028, -0.061, -0.083, -0.028, -0.028, -0.028, -0.056, -0.028,
						-0.058, -0.028, -0.028, -0.056, -0.028, -0.222, -0.056, -0.028, -0.056, -0.028, -0.056, -0.056,
						-0.056, -0.056, -0.056, -0.056, -0.028, -0.028, -0.028, -0.028, -0.028 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03BD', // char code: 957
				new double[] { 0.417, 0.442, 0.02, 0.068 }, // metrics: width,
															...
															// italic
				null, // ligatures
				new char[] { '\u03AC', '\u03B1', '\u03BB', '\u03BD', '\u03BF', '\u03C1', '\u03C9', '\u03CC', '\u03CE',
						'\u03E1', '\u1F70', '\u1F78', '\u1F7C', '\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6', '\u1FB7',
						'\u1FF2', '\u1FF3', '\u1FF4', '\u1FF6', '\u1FF7' }, // kern
																			// codes
				new double[] { -0.022, -0.022, -0.044, -0.028, -0.028, -0.006, 0.008, -0.028, 0.008, -0.167, -0.022,
						-0.028, 0.008, -0.022, -0.022, -0.022, -0.022, -0.022, 0.008, 0.008, 0.008, 0.008, 0.008 }, // kern
																													// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03BE', // char code: 958
				new double[] { 0.417, 0.696, 0.155, 0.036 }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u03AC', '\u03AD', '\u03B1', '\u03B3', '\u03B5', '\u03BF', '\u03C3', '\u03C4', '\u03C5',
						'\u03C6', '\u03C7', '\u03CC', '\u03CD', '\u03E1', '\u1F70', '\u1F72', '\u1F78', '\u1F7A',
						'\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6', '\u1FB7', '\u1FE6' }, // kern
																						// codes
				new double[] { -0.028, -0.056, -0.028, -0.039, -0.056, -0.056, -0.056, -0.028, -0.028, -0.039, -0.028,
						-0.056, -0.028, -0.056, -0.028, -0.056, -0.056, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028,
						-0.028 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03BF', // char code: 959
				new double[] { 0.472, 0.443, 0.011, 0.025 }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u03B3', '\u03BB', '\u03BC', '\u03BD', '\u03C4', '\u03C5', '\u03C7', '\u03CD', '\u03E1',
						'\u1F7A', '\u1FE6' }, // kern codes
				new double[] { -0.028, -0.028, -0.011, -0.039, -0.033, -0.056, -0.028, -0.056, -0.167, -0.056, -0.056 }, // kern
																															// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03C0', // char code: 960
				new double[] { 0.569, 0.434, 0.011, 0.068 }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u03AF', '\u03B9', '\u03BA', '\u03BF', '\u03C8', '\u03CC', '\u03E1', '\u1F76', '\u1F78',
						'\u1FD6' }, // kern codes
				new double[] { 0.028, 0.028, 0.028, -0.056, 0.028, -0.056, -0.167, 0.028, -0.056, 0.028 }, // kern
																											// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03C1', // char code: 961
				new double[] { 0.472, 0.442, 0.212, 0.028 }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u03AF', '\u03B3', '\u03B6', '\u03B9', '\u03BD', '\u03BF', '\u03C3', '\u03C7', '\u03C8',
						'\u03CC', '\u03E1', '\u1F76', '\u1F78', '\u1FD6' }, // kern
																			// codes
				new double[] { 0.028, -0.056, 0.028, 0.028, -0.05, 0.028, 0.028, -0.011, 0.017, 0.028, -0.167, 0.028,
						0.028, 0.028 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03C3', // char code: 963
				new double[] { 0.5, 0.451, 0.011, 0.081 }, // metrics: width,
															...
															// italic
				null, // ligatures
				new char[] { '\u03AC', '\u03B1', '\u03BF', '\u03C1', '\u03C9', '\u03CC', '\u03CE', '\u03E1', '\u1F70',
						'\u1F78', '\u1F7C', '\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6', '\u1FB7', '\u1FE4', '\u1FE5',
						'\u1FF2', '\u1FF3', '\u1FF4', '\u1FF6', '\u1FF7' }, // kern
																			// codes
				new double[] { -0.044, -0.044, -0.028, -0.028, -0.028, -0.028, -0.028, -0.167, -0.044, -0.028, -0.028,
						-0.044, -0.044, -0.044, -0.044, -0.044, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028,
						-0.028 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03C4', // char code: 964
				new double[] { 0.458, 0.454, 0.011, 0.075 }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u03AC', '\u03AD', '\u03B1', '\u03B5', '\u03BF', '\u03C7', '\u03C9', '\u03CC', '\u03CE',
						'\u03E1', '\u1F70', '\u1F72', '\u1F78', '\u1F7C', '\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6',
						'\u1FB7', '\u1FF2', '\u1FF3', '\u1FF4', '\u1FF6', '\u1FF7' }, // kern
																						// codes
				new double[] { -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.028, -0.167, -0.028,
		...
		setInfo('\u03C6', // char code: 966
				new double[] { 0.583, 0.443, 0.223, 0.037 }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u03AE', '\u03B3', '\u03B7', '\u03BC', '\u03BD', '\u03C4', '\u03C5', '\u03C7', '\u03CD',
						'\u03E1', '\u1F74', '\u1F7A', '\u1FC2', '\u1FC3', '\u1FC4', '\u1FC6', '\u1FC7', '\u1FE6' }, // kern
																													// codes
				new double[] { -0.028, -0.056, -0.028, -0.039, -0.039, -0.028, -0.056, -0.011, -0.056, -0.167, -0.028,
						-0.056, -0.028, -0.028, -0.028, -0.056, -0.056, -0.056 }, // kern
																					// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03C7', // char code: 967
				...
				new char[] { '\u03AC', '\u03AD', '\u03AE', '\u03AF', '\u03B1', '\u03B3', '\u03B4', '\u03B5', '\u03B7',
						...
						'\u1FD6', '\u1FE6', '\u1FF2', '\u1FF3', '\u1FF4', '\u1FF6', '\u1FF7' }, // kern
																								// codes
				new double[] { -0.067, -0.028, -0.058, -0.028, -0.067, -0.044, -0.067, -0.028, -0.058, -0.056, -0.028,
						-0.056, -0.067, -0.083, -0.044, -0.083, -0.044, -0.044, -0.039, -0.044, -0.044, -0.083, -0.028,
						-0.067, -0.083, -0.044, -0.067, -0.167, -0.067, -0.028, -0.058, -0.028, -0.083, -0.044, -0.067,
						-0.067, -0.067, -0.067, -0.067, -0.067, -0.058, -0.058, -0.058, -0.058, -0.058, -0.028, -0.044,
						-0.067, -0.067, -0.067, -0.067, -0.067 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03C8', // char code: 968
				new double[] { 0.555, 0.444, 0.226, 0.045 }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u03B3', '\u03C5', '\u03C7', '\u03CD', '\u03E1', '\u1F7A', '\u1FE6' }, // kern
																										// codes
				new double[] { -0.039, -0.056, -0.006, -0.056, -0.167, -0.056, -0.056 }, // kern
																							// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03C9', // char code: 969
				new double[] { 0.667, 0.432, 0.011, 0.019 }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u03AD', '\u03B3', '\u03B5', '\u03BC', '\u03BD', '\u03BE', '\u03C4', '\u03C5', '\u03C7',
						'\u03CD', '\u03E1', '\u1F72', '\u1F7A', '\u1FE6' }, // kern
																			// codes
				new double[] { 0.028, -0.111, 0.028, -0.028, -0.028, 0.028, -0.047, -0.028, -0.028, -0.028, -0.167,
						0.028, -0.028, -0.028 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03CE', // char code: 974
				...
				new char[] { '\u03AD', '\u03B3', '\u03B5', '\u03BC', '\u03BD', '\u03BE', '\u03C4', '\u03C5', '\u03C7',
						'\u03CD', '\u1F72', '\u1F7A', '\u1FE6' }, // kern codes
				new double[] { 0.028, -0.111, 0.028, -0.028, -0.028, 0.028, -0.047, -0.028, -0.028, -0.028, 0.028,
						-0.028, -0.028 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u1F05', // char code: 7941
				...
				new char[] { '\u03B3', '\u03B8', '\u03BD', '\u03BF', '\u03C0', '\u03C4', '\u03C5', '\u03C7', '\u03C8',
						'\u03CC', '\u03CD', '\u1F78', '\u1F7A' }, // kern codes
				new double[] { -0.083, -0.083, -0.044, -0.028, -0.044, -0.083, -0.083, -0.083, -0.028, -0.028, -0.083,
						-0.028, -0.083 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
