...
final class CMTI10 extends FontInfo {
	...
	protected final void initMetrics() {
		...
		setInfo('\u00AE', // char code: 174
				...
				new char[] { '\'', '\u003F', '\u0021', '\u0029', '\u005D' }, // kern
																				// codes
				new double[] { 0.104306, 0.104306, 0.104306, 0.104306, 0.104306 }, // kern
																					// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0041', // char code: 65
				new double[] { 0.743329, 0.683332, 0., 0. }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u006E', '\u006C', '\u0072', '\u0075', '\u006D', '\u0074', '\u0069', '\u0043', '\u004F',
						'\u0047', '\u0068', '\u0062', '\u0055', '\u006B', '\u0076', '\u0077', '\u0051', '\u0054',
						'\u0059', '\u0056', '\u0057', '\u0065', '\u0061', '\u006F', '\u0064', '\u0063', '\u0067',
						'\u0071' }, // kern codes
				new double[] { -0.025556, -0.025556, -0.025556, -0.025556, -0.025556, -0.025556, -0.025556, -0.025556,
						-0.025556, -0.025556, -0.025556, -0.025556, -0.025556, -0.025556, -0.025556, -0.025556,
						-0.025556, -0.076666, -0.076666, -0.1022215, -0.1022215, -0.051111, -0.051111, -0.051111,
		...
		setInfo('\u0044', // char code: 68
				...
				new char[] { '\u0058', '\u0057', '\u0041', '\u0056', '\u0059' }, // kern
																					// codes
				new double[] { -0.025556, -0.025556, -0.025556, -0.025556, -0.025556 }, // kern
																						// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0046', // char code: 70
				...
				new char[] { '\u006F', '\u0065', '\u0075', '\u0072', '\u0061', '\u0041', '\u004F', '\u0043', '\u0047',
						'\u0051' }, // kern codes
				new double[] { -0.076666, -0.076666, -0.076666, -0.076666, -0.076666, -0.1022215, -0.025556, -0.025556,
		...
		setInfo('\u004C', // char code: 76
				new double[] { 0.627218, 0.683332, 0., 0. }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u0054', '\u0059', '\u0056', '\u0057', '\u0065', '\u0061', '\u006F', '\u0064', '\u0063',
						'\u0067', '\u0071' }, // kern codes
				new double[] { -0.076666, -0.076666, -0.1022215, -0.1022215, -0.051111, -0.051111, -0.051111, -0.051111,
						-0.051111, -0.051111, -0.051111 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0054', // char code: 84
				new double[] { 0.715551, 0.683332, 0., 0.133055 }, // metrics:
																	...
																	// italic
				null, // ligatures
				new char[] { '\u0079', '\u0065', '\u006F', '\u0072', '\u0061', '\u0075', '\u0041' }, // kern
																										// codes
				new double[] { -0.076666, -0.076666, -0.076666, -0.076666, -0.076666, -0.076666, -0.076666 }, // kern
																												// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0059', // char code: 89
				new double[] { 0.743329, 0.683332, 0., 0.193832 }, // metrics:
																	...
																	// italic
				null, // ligatures
				new char[] { '\u0065', '\u006F', '\u0072', '\u0061', '\u0075', '\u0041' }, // kern
																							// codes
				new double[] { -0.076666, -0.076666, -0.076666, -0.076666, -0.076666, -0.076666 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0062', // char code: 98
				new double[] { 0.459997, 0.694445, 0., 0.063124 }, // metrics:
																	...
																	// italic
				null, // ligatures
				new char[] { '\u0065', '\u0061', '\u006F', '\u0064', '\u0063', '\u0067', '\u0071' }, // kern
																										// codes
				new double[] { -0.051111, -0.051111, -0.051111, -0.051111, -0.051111, -0.051111, -0.051111 }, // kern
																												// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
