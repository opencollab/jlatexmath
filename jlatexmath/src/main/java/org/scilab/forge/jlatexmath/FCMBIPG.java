	...
	protected final void initMetrics() {
		...
		setInfo('\u0390', // char code: 912
				...
				new char[] { '\u03B3', '\u03B7', '\u03B8', '\u03BA', '\u03BD', '\u03BF', '\u03C2', '\u03C3', '\u03C4',
						'\u03C7', '\u03CC', '\u03E1', '\u1F40', '\u1F41', '\u1F44', '\u1F45', '\u1F78' }, // kern
																											// codes
				new double[] { -0.08, -0.019, -0.038, -0.064, -0.064, -0.032, -0.032, -0.032, -0.096, -0.064, -0.032,
						-0.192, -0.032, -0.032, -0.032, -0.032, -0.032 }, // kern
																			// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u0391', // char code: 913
				...
				new char[] { '\u0398', '\u039F', '\u03A4', '\u03A5', '\u03A6', '\u03A8', '\u03AB', '\u03BD' }, // kern
																												// codes
				new double[] { -0.096, -0.096, -0.096, -0.16, -0.096, -0.141, -0.16, -0.112 }, // kern
																								// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03AC', // char code: 940
				...
				new char[] { '\u03B3', '\u03B8', '\u03BD', '\u03BF', '\u03C0', '\u03C4', '\u03C5', '\u03C7', '\u03C8',
						'\u03CC', '\u03CD', '\u1F78', '\u1F7A' }, // kern codes
				new double[] { -0.096, -0.096, -0.096, -0.032, -0.051, -0.096, -0.096, -0.096, -0.032, -0.032, -0.096,
						-0.032, -0.096 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03AD', // char code: 941
				...
				new char[] { '\u03AC', '\u03B1', '\u03B4', '\u03C3', '\u03C5', '\u03C7', '\u03CD', '\u03E1', '\u1F70',
						'\u1F7A', '\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6', '\u1FB7', '\u1FE6' }, // kern
																								// codes
				new double[] { -0.032, -0.032, -0.032, -0.032, -0.032, -0.01, -0.032, -0.192, -0.032, -0.032, -0.032,
						-0.032, -0.032, -0.032, -0.032, -0.032 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03B1', // char code: 945
				...
				new char[] { '\u03B3', '\u03B8', '\u03BD', '\u03BF', '\u03C0', '\u03C4', '\u03C5', '\u03C7', '\u03C8',
						'\u03CC', '\u03CD', '\u03E1', '\u1F50', '\u1F52', '\u1F54', '\u1F55', '\u1F56', '\u1F57',
						'\u1F78', '\u1F7A', '\u1FE6' }, // kern codes
				new double[] { -0.096, -0.096, -0.109, -0.032, -0.051, -0.096, -0.096, -0.096, -0.032, -0.032, -0.096,
						-0.255, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.032, -0.096, -0.096 }, // kern
																											// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03B2', // char code: 946
				...
				new char[] { '\u03AD', '\u03AF', '\u03B5', '\u03B9', '\u03BF', '\u03C4', '\u03C6', '\u03C7', '\u03C8',
						'\u03CC', '\u03E1', '\u1F72', '\u1F76', '\u1F78', '\u1FD6' }, // kern
																						// codes
				new double[] { 0.032, 0.032, 0.032, 0.032, 0.032, 0.032, 0.032, -0.032, 0.064, 0.032, -0.064, 0.032,
		...
		setInfo('\u03B4', // char code: 948
				...
				new char[] { '\u03AC', '\u03B1', '\u03B3', '\u03BC', '\u03BD', '\u03C0', '\u03C5', '\u03C7', '\u03CD',
						'\u03E1', '\u1F70', '\u1F7A', '\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6', '\u1FB7', '\u1FE6' }, // kern
																													// codes
				new double[] { -0.032, -0.032, -0.096, -0.051, -0.045, -0.032, -0.032, -0.019, -0.032, -0.192, -0.032,
						-0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032 }, // kern
																					// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03B6', // char code: 950
				...
				new char[] { '\u03AC', '\u03AD', '\u03AE', '\u03B1', '\u03B3', '\u03B4', '\u03B5', '\u03B7', '\u03B8',
						...
						'\u1FC3', '\u1FC4', '\u1FC6', '\u1FC7', '\u1FE6', '\u1FF2', '\u1FF3', '\u1FF4', '\u1FF6',
						'\u1FF7' }, // kern codes
				new double[] { -0.096, -0.096, -0.096, -0.096, -0.128, -0.064, -0.096, -0.096, -0.064, -0.064, -0.102,
						-0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.032, -0.096, -0.096, -0.096, -0.096,
						-0.064, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096,
						-0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096, -0.096 }, // kern
																													// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03B8', // char code: 952
				...
				new char[] { '\u03AD', '\u03AF', '\u03B5', '\u03B9', '\u03C8', '\u03E1', '\u1F72', '\u1F76', '\u1FD6' }, // kern
																															// codes
				new double[] { 0.032, 0.032, 0.032, 0.032, 0.032, -0.064, 0.032, 0.032, 0.032 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03BB', // char code: 955
				...
				new char[] { '\u03AC', '\u03B1', '\u03B3', '\u03B8', '\u03BC', '\u03BD', '\u03C3', '\u03C4', '\u03C5',
						'\u03C7', '\u03CD', '\u03E1', '\u1F70', '\u1F7A', '\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6',
						'\u1FB7', '\u1FE6' }, // kern codes
				new double[] { -0.016, -0.016, -0.16, -0.051, 0.016, -0.096, -0.032, -0.032, -0.064, -0.064, -0.064,
						-0.192, -0.016, -0.064, -0.016, -0.016, -0.016, -0.016, -0.016, -0.064 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03BC', // char code: 956
				...
				new char[] { '\u03AC', '\u03B1', '\u03B3', '\u03B6', '\u03B8', '\u03BD', '\u03BF', '\u03C0', '\u03C3',
						...
						'\u1FF2', '\u1FF3', '\u1FF4', '\u1FF6', '\u1FF7' }, // kern
																			// codes
				new double[] { -0.064, -0.064, -0.096, -0.032, -0.07, -0.096, -0.032, -0.032, -0.032, -0.064, -0.032,
						-0.067, -0.032, -0.032, -0.064, -0.032, -0.255, -0.064, -0.032, -0.064, -0.032, -0.064, -0.064,
						-0.064, -0.064, -0.064, -0.064, -0.032, -0.032, -0.032, -0.032, -0.032 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03BD', // char code: 957
				...
				new char[] { '\u03AC', '\u03B1', '\u03BB', '\u03BD', '\u03BF', '\u03C1', '\u03C9', '\u03CC', '\u03CE',
						...
						'\u1FF2', '\u1FF3', '\u1FF4', '\u1FF6', '\u1FF7' }, // kern
																			// codes
				new double[] { -0.026, -0.026, -0.051, -0.032, -0.032, -0.006, 0.01, -0.032, 0.01, -0.192, -0.026,
						-0.032, 0.01, -0.026, -0.026, -0.026, -0.026, -0.026, 0.01, 0.01, 0.01, 0.01, 0.01 }, // kern
																												// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03BE', // char code: 958
				...
				new char[] { '\u03AC', '\u03AD', '\u03B1', '\u03B3', '\u03B5', '\u03BF', '\u03C3', '\u03C4', '\u03C5',
						...
						'\u1FB2', '\u1FB3', '\u1FB4', '\u1FB6', '\u1FB7', '\u1FE6' }, // kern
																						// codes
				new double[] { -0.032, -0.064, -0.032, -0.045, -0.064, -0.064, -0.064, -0.032, -0.032, -0.045, -0.032,
						-0.064, -0.032, -0.064, -0.032, -0.064, -0.064, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032,
						-0.032 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03BF', // char code: 959
				...
				new char[] { '\u03B3', '\u03BB', '\u03BC', '\u03BD', '\u03C4', '\u03C5', '\u03C7', '\u03CD', '\u03E1',
						'\u1F7A', '\u1FE6' }, // kern codes
				new double[] { -0.032, -0.032, -0.013, -0.045, -0.038, -0.064, -0.032, -0.064, -0.192, -0.064, -0.064 }, // kern
																															// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03C0', // char code: 960
				...
				new char[] { '\u03AF', '\u03B9', '\u03BA', '\u03BF', '\u03C8', '\u03CC', '\u03E1', '\u1F76', '\u1F78',
						'\u1FD6' }, // kern codes
				new double[] { 0.032, 0.032, 0.032, -0.064, 0.032, -0.064, -0.192, 0.032, -0.064, 0.032 }, // kern
																											// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03C1', // char code: 961
				...
				new char[] { '\u03AF', '\u03B3', '\u03B6', '\u03B9', '\u03BD', '\u03BF', '\u03C3', '\u03C7', '\u03C8',
						'\u03CC', '\u03E1', '\u1F76', '\u1F78', '\u1FD6' }, // kern
																			// codes
				new double[] { 0.032, -0.064, 0.032, 0.032, -0.057, 0.032, 0.032, -0.013, 0.019, 0.032, -0.192, 0.032,
						0.032, 0.032 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03C3', // char code: 963
				...
				new char[] { '\u03AC', '\u03B1', '\u03BF', '\u03C1', '\u03C9', '\u03CC', '\u03CE', '\u03E1', '\u1F70',
						...
						'\u1FF2', '\u1FF3', '\u1FF4', '\u1FF6', '\u1FF7' }, // kern
																			// codes
				new double[] { -0.051, -0.051, -0.032, -0.032, -0.032, -0.032, -0.032, -0.192, -0.051, -0.032, -0.032,
						-0.051, -0.051, -0.051, -0.051, -0.051, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032,
						-0.032 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03C4', // char code: 964
				...
				new char[] { '\u03AC', '\u03AD', '\u03B1', '\u03B5', '\u03BF', '\u03C7', '\u03C9', '\u03CC', '\u03CE',
						...
						'\u1FB7', '\u1FF2', '\u1FF3', '\u1FF4', '\u1FF6', '\u1FF7' }, // kern
																						// codes
				new double[] { -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.192, -0.032,
		...
		setInfo('\u03C6', // char code: 966
				...
				new char[] { '\u03AE', '\u03B3', '\u03B7', '\u03BC', '\u03BD', '\u03C4', '\u03C5', '\u03C7', '\u03CD',
						'\u03E1', '\u1F74', '\u1F7A', '\u1FC2', '\u1FC3', '\u1FC4', '\u1FC6', '\u1FC7', '\u1FE6' }, // kern
																													// codes
				new double[] { -0.032, -0.064, -0.032, -0.045, -0.045, -0.032, -0.064, -0.013, -0.064, -0.192, -0.032,
						-0.064, -0.032, -0.032, -0.032, -0.064, -0.064, -0.064 }, // kern
																					// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03C7', // char code: 967
				...
				new char[] { '\u03AC', '\u03AD', '\u03AE', '\u03AF', '\u03B1', '\u03B3', '\u03B4', '\u03B5', '\u03B7',
						...
						'\u1FD6', '\u1FE6', '\u1FF2', '\u1FF3', '\u1FF4', '\u1FF6', '\u1FF7' }, // kern
																								// codes
				new double[] { -0.077, -0.032, -0.067, -0.032, -0.077, -0.051, -0.077, -0.032, -0.067, -0.064, -0.032,
						-0.064, -0.077, -0.096, -0.051, -0.096, -0.051, -0.051, -0.045, -0.051, -0.051, -0.096, -0.032,
						-0.077, -0.096, -0.051, -0.077, -0.192, -0.077, -0.032, -0.067, -0.032, -0.096, -0.051, -0.077,
						-0.077, -0.077, -0.077, -0.077, -0.077, -0.067, -0.067, -0.067, -0.067, -0.067, -0.032, -0.051,
						-0.077, -0.077, -0.077, -0.077, -0.077 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03C8', // char code: 968
				...
				new char[] { '\u03B3', '\u03C5', '\u03C7', '\u03CD', '\u03E1', '\u1F7A', '\u1FE6' }, // kern
																										// codes
				new double[] { -0.045, -0.064, -0.006, -0.064, -0.192, -0.064, -0.064 }, // kern
																							// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u03C9', // char code: 969
				...
				new char[] { '\u03AD', '\u03B3', '\u03B5', '\u03BC', '\u03BD', '\u03BE', '\u03C4', '\u03C5', '\u03C7',
						'\u03CD', '\u03E1', '\u1F72', '\u1F7A', '\u1FE6' }, // kern
																			// codes
				new double[] { 0.032, -0.128, 0.032, -0.032, -0.032, 0.032, -0.054, -0.032, -0.032, -0.032, -0.192,
						0.032, -0.032, -0.032 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03CE', // char code: 974
				...
				new char[] { '\u03AD', '\u03B3', '\u03B5', '\u03BC', '\u03BD', '\u03BE', '\u03C4', '\u03C5', '\u03C7',
						'\u03CD', '\u1F72', '\u1F7A', '\u1FE6' }, // kern codes
				new double[] { 0.032, -0.128, 0.032, -0.032, -0.032, 0.032, -0.054, -0.032, -0.032, -0.032, 0.032,
						-0.032, -0.032 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u1F05', // char code: 7941
				...
				new char[] { '\u03B3', '\u03B8', '\u03BD', '\u03BF', '\u03C0', '\u03C4', '\u03C5', '\u03C7', '\u03C8',
						'\u03CC', '\u03CD', '\u1F78', '\u1F7A' }, // kern codes
				new double[] { -0.096, -0.096, -0.051, -0.032, -0.051, -0.096, -0.096, -0.096, -0.032, -0.032, -0.096,
						-0.032, -0.096 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
