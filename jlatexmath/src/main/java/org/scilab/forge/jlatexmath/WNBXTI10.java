	...
	protected final void initMetrics() {
		setInfo('\u040A', // char code: 1034
				...
				new char[] { '\u0416', '\u0425', '\u041E', '\u0424', '\u0472', '\u0421', '\u0404', '\u0422', '\u042A',
						...
						'\u0446', '\u0448', '\u0449', '\u044C', '\u044B', '\u0443' }, // kern
																						// codes
				new double[] { -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.088333,
						-0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.117777, -0.029445,
						-0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445,
						-0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445,
		...
		setInfo('\u042D', // char code: 1069
				...
				new char[] { '\u0410', '\u0414', '\u0416', '\u0425', '\u0423', '\u0474', '\u042F' }, // kern
																										// codes
				new double[] { -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445 }, // kern
																												// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u045A', // char code: 1114
				...
				new char[] { '\u043B', '\u043C', '\u0459', '\u0475', '\u044A', '\u0447', '\u043E', '\u0473', '\u0444',
						'\u0454' }, // kern codes
				new double[] { -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.088333, -0.029445, -0.029445,
						-0.029445, -0.029445 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u044D', // char code: 1101
				...
				new char[] { '\u0444', '\u0430', '\u043B', '\u043C', '\u0459' }, // kern
																					// codes
				new double[] { -0.058888, -0.058888, -0.029445, -0.029445, -0.029445 }, // kern
																						// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0416', // char code: 1046
				...
				new char[] { '\u041E', '\u0424', '\u0472', '\u0421', '\u0404', '\u0447' }, // kern
																							// codes
				new double[] { -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0474', // char code: 1140
				...
				new char[] { '\u0410', '\u042F', '\u041E', '\u0424', '\u0472', '\u0421', '\u0404', '\u0430', '\u043E',
						...
						'\u044B', '\u0443', '\u0475', '\u044A', '\u043B', '\u043C', '\u0459' }, // kern
																								// codes
				new double[] { -0.117777, -0.117777, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.088333,
						-0.088333, -0.088333, -0.088333, -0.088333, -0.117777, -0.117777, -0.117777, -0.117777,
						-0.117777, -0.117777, -0.117777, -0.117777, -0.117777, -0.117777, -0.117777, -0.117777,
		...
		setInfo('\u0410', // char code: 1040
				...
				new char[] { '\u041E', '\u0424', '\u0472', '\u0421', '\u0404', '\u0422', '\u042A', '\u0402', '\u040B',
						...
						'\u043F', '\u0442', '\u044E', '\u0463', '\u0456', '\u0438', '\u0439', '\u0446', '\u0448',
						'\u0449', '\u044C', '\u044B', '\u0443' }, // kern codes
				new double[] { -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.088333, -0.088333, -0.088333,
						-0.088333, -0.088333, -0.088333, -0.088333, -0.117777, -0.029445, -0.029445, -0.029445,
						-0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445,
						-0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445 }, // kern
																										// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0413', // char code: 1043
				...
				new char[] { '\u0410', '\u0414', '\u042F', '\u041B', '\u0409', '\u0430', '\u043E', '\u0473', '\u0435',
						...
						'\u044C', '\u044B', '\u0443', '\u0475', '\u044A', '\u043B', '\u043C', '\u0459' }, // kern
																											// codes
				new double[] { -0.088333, -0.088333, -0.088333, -0.029445, -0.029445, -0.088333, -0.088333, -0.088333,
						-0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.088333,
						-0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.088333,
		...
		setInfo('\u0420', // char code: 1056
				...
				new char[] { '\u0410', '\u0414', '\u041B', '\u0409', '\u042F', '\u0430', '\u043E', '\u0473', '\u0435',
						'\u0451', '\u0434', '\u043B', '\u0459' }, // kern codes
				new double[] { -0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.029445, -0.029445, -0.029445,
						-0.029445, -0.029445, -0.088333, -0.088333, -0.088333 }, // kern
																					// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0423', // char code: 1059
				...
				new char[] { '\u0410', '\u042F', '\u0414', '\u041B', '\u0409', '\u041E', '\u0424', '\u0472', '\u0421',
						...
						'\u0439', '\u0446', '\u0448', '\u0449', '\u044C', '\u044B', '\u0443', '\u0475', '\u044A',
						'\u043B', '\u043C', '\u0459' }, // kern codes
				new double[] { -0.088333, -0.088333, -0.058888, -0.058888, -0.058888, -0.029445, -0.029445, -0.029445,
						-0.029445, -0.029445, -0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.088333,
						-0.088333, -0.117777, -0.117777, -0.117777, -0.117777, -0.117777, -0.117777, -0.117777,
						-0.117777, -0.117777, -0.117777, -0.117777, -0.117777, -0.117777 }, // kern
																							// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u043B', // char code: 1083
				...
				new char[] { '\u043B', '\u043C', '\u0459', '\u0475', '\u044A', '\u0447' }, // kern
																							// codes
				new double[] { -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.088333 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
