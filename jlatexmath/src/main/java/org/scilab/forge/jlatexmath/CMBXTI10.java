...
final class CMBXTI10 extends FontInfo {
	...
	protected final void initMetrics() {
		...
		setInfo('\u00AE', // char code: 174
				...
				new char[] { '\'', '\u003F', '\u0021', '\u0029', '\u005D' }, // kern
																				// codes
				new double[] { 0.106667, 0.106667, 0.106667, 0.106667, 0.106667 }, // kern
																					// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0041', // char code: 65
				...
				new char[] { '\u006E', '\u006C', '\u0072', '\u0075', '\u006D', '\u0074', '\u0069', '\u0043', '\u004F',
						...
						'\u0059', '\u0056', '\u0057', '\u0065', '\u0061', '\u006F', '\u0064', '\u0063', '\u0067',
						'\u0071' }, // kern codes
				new double[] { -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445,
						-0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445, -0.029445,
						-0.029445, -0.088333, -0.088333, -0.117777, -0.117777, -0.058888, -0.058888, -0.058888,
		...
		setInfo('\u0044', // char code: 68
				...
				new char[] { '\u0058', '\u0057', '\u0041', '\u0056', '\u0059' }, // kern
																					// codes
				new double[] { -0.029445, -0.029445, -0.029445, -0.029445, -0.029445 }, // kern
																						// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0046', // char code: 70
				...
				new char[] { '\u006F', '\u0065', '\u0075', '\u0072', '\u0061', '\u0041', '\u004F', '\u0043', '\u0047',
						'\u0051' }, // kern codes
				new double[] { -0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.117777, -0.029445, -0.029445,
		...
		setInfo('\u004C', // char code: 76
				...
				new char[] { '\u0054', '\u0059', '\u0056', '\u0057', '\u0065', '\u0061', '\u006F', '\u0064', '\u0063',
						'\u0067', '\u0071' }, // kern codes
				new double[] { -0.088333, -0.088333, -0.117777, -0.117777, -0.058888, -0.058888, -0.058888, -0.058888,
						-0.058888, -0.058888, -0.058888 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0054', // char code: 84
				...
				new char[] { '\u0079', '\u0065', '\u006F', '\u0072', '\u0061', '\u0075', '\u0041' }, // kern
																										// codes
				new double[] { -0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.088333 }, // kern
																												// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0059', // char code: 89
				...
				new char[] { '\u0065', '\u006F', '\u0072', '\u0061', '\u0075', '\u0041' }, // kern
																							// codes
				new double[] { -0.088333, -0.088333, -0.088333, -0.088333, -0.088333, -0.088333 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0062', // char code: 98
				...
				new char[] { '\u0065', '\u0061', '\u006F', '\u0064', '\u0063', '\u0067', '\u0071' }, // kern
																										// codes
				new double[] { -0.058888, -0.058888, -0.058888, -0.058888, -0.058888, -0.058888, -0.058888 }, // kern
																												// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
