...
final class JLMR10 extends FontInfo {
    ...
    protected final void initMetrics() {
        setInfo('\u0021', // char code: 33
                new double[] {0.552, 0.485, 0., 0.}, // metrics: width, height, depth, italic
                null, // ligatures
                null, // kern codes
                null, // kern values
                null, '\0', // next larger
        ...
        setInfo('\"', // char code: 34
                new double[] {0.441, 0.485, 0., 0.}, // metrics: width, height, depth, italic
                null, // ligatures
                null, // kern codes
                null, // kern values
                null, '\0', // next larger
        ...
        setInfo('\u0025', // char code: 37
                new double[] {1.159, 0.751, 0., 0.}, // metrics: width, height, depth, italic
                null, // ligatures
                null, // kern codes
                null, // kern values
                null, '\0', // next larger
        ...
        setInfo('\u0026', // char code: 38
                new double[] {1.501, 0.751, 0., 0.}, // metrics: width, height, depth, italic
                null, // ligatures
                null, // kern codes
                null, // kern values
                null, '\0', // next larger
