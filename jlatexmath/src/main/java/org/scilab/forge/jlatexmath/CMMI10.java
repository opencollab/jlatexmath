	...
	protected final void initMetrics() {
		...
		setInfo('\u003D', // char code: 61
				...
				new char[] { '\u00A2', '\u0041', '\u004D', '\u004E', '\u0059', '\u005A' }, // kern
																							// codes
				new double[] { -0.055555, -0.055555, -0.055555, -0.055555, 0.055555, -0.055555 }, // kern
																									// values
				Configuration.getFonts().cmex10, '\u00B1', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u004E', // char code: 78
				...
				new char[] { '\u003D', '\u003D', '\u003B', '\u003A', '\u00C4' }, // kern
																					// codes
				new double[] { -0.083334, -0.027779, -0.055555, -0.055555, 0.083336 }, // kern
																						// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0064', // char code: 100
				...
				new char[] { '\u0059', '\u005A', '\u006A', '\u0066', '\u00C4' }, // kern
																					// codes
				new double[] { 0.055555, -0.055555, -0.111112, -0.166667, 0.166672 }, // kern
																						// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
