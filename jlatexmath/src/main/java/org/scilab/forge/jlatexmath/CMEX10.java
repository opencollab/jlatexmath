...
final class CMEX10 extends FontInfo {
	...
	protected final void initMetrics() {
		...
		setInfo('\u003D', // char code: 61
				...
				null, // kern values
				null, '\0', // next larger
				new char[] { TeXFont.NONE, TeXFont.NONE, '\u0077', TeXFont.NONE }); // extension:
																					// top,
																					// mid,
																					// rep,
																					// bot
		...
		setInfo('\u0042', // char code: 66
				...
				null, // kern values
				null, '\0', // next larger
				new char[] { TeXFont.NONE, TeXFont.NONE, '\u0042', TeXFont.NONE }); // extension:
																					// top,
																					// mid,
																					// rep,
																					// bot
		setInfo('\u0043', // char code: 67
				...
				null, // kern values
				null, '\0', // next larger
				new char[] { TeXFont.NONE, TeXFont.NONE, '\u0043', TeXFont.NONE }); // extension:
																					// top,
																					// mid,
																					// rep,
																					// bot
