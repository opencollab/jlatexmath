...
public class GraphicsStub implements Graphics2DInterface {
	...
	private Color color;
	private Font font;
	private List<org.scilab.forge.jlatexmath.share.platform.graphics.stubs.AffineTransform> transformList = new ArrayList<org.scilab.forge.jlatexmath.share.platform.graphics.stubs.AffineTransform>();
	private org.scilab.forge.jlatexmath.share.platform.graphics.stubs.AffineTransform currentTransform;

	public GraphicsStub() {
		transformList = new ArrayList<org.scilab.forge.jlatexmath.share.platform.graphics.stubs.AffineTransform>();
		reset();
	}

	public void reset() {
		transformList.clear();
		currentTransform = new org.scilab.forge.jlatexmath.share.platform.graphics.stubs.AffineTransform();
		font = new FontStub();
		color = new ColorStub();
	...
	public void saveTransformation() {
		transformList
				.add((org.scilab.forge.jlatexmath.share.platform.graphics.stubs.AffineTransform) currentTransform
						.createClone());
	}
