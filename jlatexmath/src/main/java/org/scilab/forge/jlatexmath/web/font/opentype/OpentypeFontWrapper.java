 ...
 * version.
 */
package org.scilab.forge.jlatexmath.web.font.opentype;
...
public class OpentypeFontWrapper implements FontWrapper {
	...
	public native void drawGlyphNative(String c, double x, double y,
		...
		var font = this.@org.scilab.forge.jlatexmath.web.font.opentype.OpentypeFontWrapper::impl;
		// font not loaded yet
		if (!font) {
			return;
		}
		var glyph = this.@org.scilab.forge.jlatexmath.web.font.opentype.OpentypeFontWrapper::getGlyph(Ljava/lang/String;)(c);
		if (glyph) {
			glyph.size = size;
			glyph.unitsPerEm = font[0];
			@org.scilab.forge.jlatexmath.web.font.opentype.OpentypeFontWrapper::drawPath(Lcom/google/gwt/core/client/JavaScriptObject;IILcom/google/gwt/canvas/client/Canvas;)(glyph, x, y, ctx);
		}
	}-*/;
