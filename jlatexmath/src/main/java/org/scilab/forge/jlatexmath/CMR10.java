...
final class CMR10 extends FontInfo {
	...
	protected final void initMetrics() {
		...
		setInfo('\u00AE', // char code: 174
				...
				new char[] { '\'', '\u003F', '\u0021', '\u0029', '\u005D' }, // kern
																				// codes
				new double[] { 0.077779, 0.077779, 0.077779, 0.077779, 0.077779 }, // kern
																					// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0041', // char code: 65
				...
				new char[] { '\u0074', '\u0043', '\u004F', '\u0047', '\u0055', '\u0051', '\u0054', '\u0059', '\u0056',
						'\u0057' }, // kern codes
				new double[] { -0.027779, -0.027779, -0.027779, -0.027779, -0.027779, -0.027779, -0.083334, -0.083334,
						-0.111112, -0.111112 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0046', // char code: 70
				...
				new char[] { '\u006F', '\u0065', '\u0075', '\u0072', '\u0061', '\u0041', '\u004F', '\u0043', '\u0047',
						'\u0051' }, // kern codes
				new double[] { -0.083334, -0.083334, -0.083334, -0.083334, -0.083334, -0.111112, -0.027779, -0.027779,
		...
		setInfo('\u0050', // char code: 80
				...
				new char[] { '\u0041', '\u006F', '\u0065', '\u0061', '\u002E', '\u002C' }, // kern
																							// codes
				new double[] { -0.083334, -0.027779, -0.027779, -0.027779, -0.083334, -0.083334 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0054', // char code: 84
				...
				new char[] { '\u0079', '\u0065', '\u006F', '\u0072', '\u0061', '\u0041', '\u0075' }, // kern
																										// codes
				new double[] { -0.027779, -0.083334, -0.083334, -0.083334, -0.083334, -0.083334, -0.083334 }, // kern
																												// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0059', // char code: 89
				...
				new char[] { '\u0065', '\u006F', '\u0072', '\u0061', '\u0041', '\u0075' }, // kern
																							// codes
				new double[] { -0.083334, -0.083334, -0.083334, -0.083334, -0.083334, -0.083334 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0062', // char code: 98
				...
				new char[] { '\u0065', '\u006F', '\u0078', '\u0064', '\u0063', '\u0071', '\u0076', '\u006A', '\u0079',
						'\u0077' }, // kern codes
				new double[] { 0.027779, 0.027779, -0.027779, 0.027779, 0.027779, 0.027779, -0.027779, 0.055555,
						-0.027779, -0.027779 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0068', // char code: 104
				...
				new char[] { '\u0074', '\u0075', '\u0062', '\u0079', '\u0076', '\u0077' }, // kern
																							// codes
				new double[] { -0.027779, -0.027779, -0.027779, -0.027779, -0.027779, -0.027779 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u006B', // char code: 107
				...
				new char[] { '\u0061', '\u0065', '\u0061', '\u006F', '\u0063' }, // kern
																					// codes
				new double[] { -0.055555, -0.027779, -0.027779, -0.027779, -0.027779 }, // kern
																						// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0079', // char code: 121
				...
				new char[] { '\u006F', '\u0065', '\u0061', '\u002E', '\u002C' }, // kern
																					// codes
				new double[] { -0.027779, -0.027779, -0.027779, -0.083334, -0.083334 }, // kern
																						// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
