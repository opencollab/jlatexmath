	...
	protected final void initMetrics() {
		setInfo('\u040A', // char code: 1034
				...
				new char[] { '\u0416', '\u0425', '\u041E', '\u0424', '\u0472', '\u0421', '\u0404', '\u0422', '\u042A',
						'\u0402', '\u040B', '\u0462', '\u0427', '\u0423', '\u0474', '\u0442', '\u044A', '\u0463',
						'\u0447' }, // kern codes
				new double[] { -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.091667,
						-0.091667, -0.091667, -0.091667, -0.091667, -0.091667, -0.030556, -0.091667, -0.030556,
		...
		setInfo('\u042D', // char code: 1069
				new double[] { 0.702782, 0.694445, 0., 0. }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u0410', '\u0414', '\u0416', '\u0425', '\u0423', '\u0474' }, // kern
																							// codes
				new double[] { -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u045A', // char code: 1114
				...
				new char[] { '\u0443', '\u0475', '\u0442', '\u044A', '\u0463', '\u0447', '\u043E', '\u0473', '\u0444',
						'\u0454' }, // kern codes
				new double[] { -0.061111, -0.061111, -0.030556, -0.030556, -0.030556, -0.091667, -0.030556, -0.030556,
						-0.030556, -0.030556 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0416', // char code: 1046
				...
				new char[] { '\u041E', '\u0424', '\u0472', '\u0421', '\u0404', '\u0447', '\u0442', '\u044A', '\u0463' }, // kern
																															// codes
				new double[] { -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556,
		...
		setInfo('\u0474', // char code: 1140
				new double[] { 0.794449, 0.694445, 0., 0.015279 }, // metrics:
																	...
																	// italic
				null, // ligatures
				new char[] { '\u0410', '\u0414', '\u041B', '\u0409', '\u041E', '\u0424', '\u0472', '\u0421', '\u0404',
						'\u0430', '\u043E', '\u0473', '\u0435', '\u0451', '\u0434', '\u043B', '\u0459', '\u044F' }, // kern
																													// codes
				new double[] { -0.091667, -0.061111, -0.061111, -0.061111, -0.030556, -0.030556, -0.030556, -0.030556,
						-0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.091667, -0.091667,
						-0.091667, -0.091667 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0436', // char code: 1078
				...
				new char[] { '\u0430', '\u043E', '\u0473', '\u0441', '\u0454', '\u0435', '\u0451' }, // kern
																										// codes
				new double[] { -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556 }, // kern
																												// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0475', // char code: 1141
				...
				new char[] { '\u0430', '\u043E', '\u0473', '\u0441', '\u0454', '\u0435', '\u0451', '\u044F', '\u0434',
						'\u043B', '\u0459' }, // kern codes
				new double[] { -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556,
						-0.061111, -0.061111, -0.061111 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0410', // char code: 1040
				...
				new char[] { '\u041E', '\u0424', '\u0472', '\u0421', '\u0404', '\u0422', '\u042A', '\u0402', '\u040B',
						'\u0462', '\u0427', '\u0423', '\u0474', '\u0442', '\u044A', '\u0463', '\u0447' }, // kern
																											// codes
				new double[] { -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.091667, -0.091667, -0.091667,
						-0.091667, -0.091667, -0.091667, -0.030556, -0.091667, -0.030556, -0.030556, -0.030556,
						-0.091667 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0413', // char code: 1043
				new double[] { 0.580559, 0.694445, 0., 0. }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u0410', '\u0414', '\u041B', '\u0409', '\u0430', '\u043E', '\u0473', '\u0435', '\u0451',
						'\u0441', '\u0454', '\u0444', '\u0434', '\u043B', '\u0459', '\u044F' }, // kern
																								// codes
				new double[] { -0.091667, -0.091667, -0.061111, -0.061111, -0.091667, -0.091667, -0.091667, -0.091667,
						-0.091667, -0.091667, -0.091667, -0.091667, -0.091667, -0.091667, -0.091667, -0.091667 }, // kern
																													// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0420', // char code: 1056
				...
				new char[] { '\u0410', '\u0414', '\u041B', '\u0409', '\u0430', '\u043E', '\u0473', '\u0435', '\u0451',
						'\u0434', '\u043B', '\u0459' }, // kern codes
				new double[] { -0.091667, -0.091667, -0.091667, -0.091667, -0.030556, -0.030556, -0.030556, -0.030556,
						-0.030556, -0.091667, -0.091667, -0.091667 }, // kern
																		// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0423', // char code: 1059
				...
				new char[] { '\u0410', '\u0414', '\u041B', '\u0409', '\u041E', '\u0424', '\u0472', '\u0421', '\u0404',
						'\u0430', '\u043E', '\u0473', '\u0435', '\u0451', '\u0441', '\u0454', '\u0434', '\u043B',
						'\u0459', '\u044F' }, // kern codes
				new double[] { -0.030556, -0.061111, -0.061111, -0.061111, -0.030556, -0.030556, -0.030556, -0.030556,
						-0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556,
