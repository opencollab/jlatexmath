...
final class CMBX10 extends FontInfo {
	...
	protected final void initMetrics() {
		...
		setInfo('\u00AE', // char code: 174
				...
				new char[] { '\'', '\u003F', '\u0021', '\u0029', '\u005D' }, // kern
																				// codes
				new double[] { 0.109027, 0.109027, 0.109027, 0.109027, 0.109027 }, // kern
																					// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0041', // char code: 65
				new double[] { 0.86944, 0.686111, 0., 0. }, // metrics: width,
															...
															// italic
				null, // ligatures
				new char[] { '\u0074', '\u0043', '\u004F', '\u0047', '\u0055', '\u0051', '\u0054', '\u0059', '\u0056',
						'\u0057' }, // kern codes
				new double[] { -0.031944, -0.031944, -0.031944, -0.031944, -0.031944, -0.031944, -0.095833, -0.095833,
						-0.127777, -0.127777 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0046', // char code: 70
				new double[] { 0.723607, 0.686111, 0., 0. }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u006F', '\u0065', '\u0075', '\u0072', '\u0061', '\u0041', '\u004F', '\u0043', '\u0047',
						'\u0051' }, // kern codes
				new double[] { -0.095833, -0.095833, -0.095833, -0.095833, -0.095833, -0.127777, -0.031944, -0.031944,
		...
		setInfo('\u0050', // char code: 80
				new double[] { 0.786107, 0.686111, 0., 0. }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u0041', '\u006F', '\u0065', '\u0061', '\u002E', '\u002C' }, // kern
																							// codes
				new double[] { -0.095833, -0.031944, -0.031944, -0.031944, -0.095833, -0.095833 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0054', // char code: 84
				new double[] { 0.799995, 0.686111, 0., 0. }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u0079', '\u0065', '\u006F', '\u0072', '\u0061', '\u0041', '\u0075' }, // kern
																										// codes
				new double[] { -0.031944, -0.095833, -0.095833, -0.095833, -0.095833, -0.095833, -0.095833 }, // kern
																												// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0059', // char code: 89
				new double[] { 0.86944, 0.686111, 0., 0.028749 }, // metrics:
																	...
																	// italic
				null, // ligatures
				new char[] { '\u0065', '\u006F', '\u0072', '\u0061', '\u0041', '\u0075' }, // kern
																							// codes
				new double[] { -0.095833, -0.095833, -0.095833, -0.095833, -0.095833, -0.095833 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0062', // char code: 98
				new double[] { 0.6388855, 0.694445, 0., 0. }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u0065', '\u006F', '\u0078', '\u0064', '\u0063', '\u0071', '\u0076', '\u006A', '\u0079',
						'\u0077' }, // kern codes
				new double[] { 0.031944, 0.031944, -0.031944, 0.031944, 0.031944, 0.031944, -0.031944, 0.063889,
						-0.031944, -0.031944 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0068', // char code: 104
				new double[] { 0.6388855, 0.694445, 0., 0. }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u0074', '\u0075', '\u0062', '\u0079', '\u0076', '\u0077' }, // kern
																							// codes
				new double[] { -0.031944, -0.031944, -0.031944, -0.031944, -0.031944, -0.031944 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u006B', // char code: 107
				...
				new char[] { '\u0061', '\u0065', '\u0061', '\u006F', '\u0063' }, // kern
																					// codes
				new double[] { -0.063889, -0.031944, -0.031944, -0.031944, -0.031944 }, // kern
																						// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0079', // char code: 121
				...
				new char[] { '\u006F', '\u0065', '\u0061', '\u002E', '\u002C' }, // kern
																					// codes
				new double[] { -0.031944, -0.031944, -0.031944, -0.095833, -0.095833 }, // kern
																						// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
