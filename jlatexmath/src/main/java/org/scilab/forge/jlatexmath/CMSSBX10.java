	...
	protected final void initMetrics() {
		...
		setInfo('\u0041', // char code: 65
				...
				new char[] { '\u0074', '\u0043', '\u004F', '\u0047', '\u0055', '\u0051', '\u0054', '\u0059', '\u0056',
						'\u0057' }, // kern codes
				new double[] { -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.091667, -0.091667,
						-0.122223, -0.122223 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0044', // char code: 68
				...
				new char[] { '\u0058', '\u0057', '\u0041', '\u0056', '\u0059' }, // kern
																					// codes
				new double[] { -0.030556, -0.030556, -0.030556, -0.030556, -0.030556 }, // kern
																						// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0046', // char code: 70
				...
				new char[] { '\u006F', '\u0065', '\u0075', '\u0072', '\u0061', '\u0041', '\u004F', '\u0043', '\u0047',
						'\u0051' }, // kern codes
				new double[] { -0.030556, -0.030556, -0.030556, -0.030556, -0.030556, -0.091667, -0.030556, -0.030556,
		...
		setInfo('\u0050', // char code: 80
				...
				new char[] { '\u0041', '\u006F', '\u0065', '\u0061', '\u002E', '\u002C' }, // kern
																							// codes
				new double[] { -0.091667, -0.030556, -0.030556, -0.030556, -0.091667, -0.091667 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0054', // char code: 84
				...
				new char[] { '\u0079', '\u0065', '\u006F', '\u0072', '\u0061', '\u0041', '\u0075' }, // kern
																										// codes
				new double[] { -0.091667, -0.091667, -0.091667, -0.091667, -0.091667, -0.091667, -0.091667 }, // kern
																												// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0059', // char code: 89
				...
				new char[] { '\u0065', '\u006F', '\u0072', '\u0061', '\u0041', '\u0075' }, // kern
																							// codes
				new double[] { -0.091667, -0.091667, -0.091667, -0.091667, -0.091667, -0.091667 }, // kern
																									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0062', // char code: 98
				new double[] { 0.561114, 0.694445, 0., 0. }, // metrics: width,
																...
																// depth, italic
				null, // ligatures
				new char[] { '\u0065', '\u006F', '\u0078', '\u0064', '\u0063', '\u0071', '\u0072', '\u0079', '\u0077' }, // kern
																															// codes
		...
		setInfo('\u0079', // char code: 121
				...
				new char[] { '\u006F', '\u0065', '\u0061', '\u002E', '\u002C' }, // kern
																					// codes
				new double[] { -0.030556, -0.030556, -0.030556, -0.091667, -0.091667 }, // kern
																						// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
