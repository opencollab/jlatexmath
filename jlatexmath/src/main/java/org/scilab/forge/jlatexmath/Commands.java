	...
	static {
		...
		map.put("bmod", new Command0A() {
			...
			public Atom newI(TeXParser tp) {
				...
				final RowAtom ra = new RowAtom(sp, new RomanAtom(
						TeXParser.getAtomForLatinStr("mod", true).changeType(TeXConstants.TYPE_BINARY_OPERATOR)), sp);
				return ra;
			}
		});
		...
		map.put("Longrightarrow", new Command0A() {
			...
			public Atom newI(TeXParser tp) {
				final RowAtom ra = new RowAtom(3);
				ra.add(Symbols.BIG_RELBAR, new SpaceAtom(TeXLength.Unit.EM, -0.177), Symbols.BIG_RIGHTARROW);
				ra.setShape(true);
				return new TypedAtom(TeXConstants.TYPE_RELATION, ra);
			}
		});
		map.put("Longleftarrow", new Command0A() {
			...
			public Atom newI(TeXParser tp) {
				final RowAtom ra = new RowAtom(3);
				ra.add(Symbols.BIG_LEFTARROW, new SpaceAtom(TeXLength.Unit.EM, -0.177), Symbols.BIG_RELBAR);
				ra.setShape(true);
				return new TypedAtom(TeXConstants.TYPE_RELATION, ra);
			}
		});
		map.put("longleftarrow", new Command0A() {
			...
			public Atom newI(TeXParser tp) {
				final RowAtom ra = new RowAtom(3);
				ra.add(Symbols.LEFTARROW, new SpaceAtom(TeXLength.Unit.EM, -0.206),
		...
		map.put("longrightarrow", new Command0A() {
			...
			public Atom newI(TeXParser tp) {
				final RowAtom ra = new RowAtom(3);
				ra.add(Symbols.MINUS.changeType(TeXConstants.TYPE_RELATION), new SpaceAtom(TeXLength.Unit.EM, -0.206),
						Symbols.RIGHTARROW);
				ra.setShape(true);
				return new TypedAtom(TeXConstants.TYPE_RELATION, ra);
			}
		...
		map.put("longleftrightarrow", new Command0A() {
			...
			public Atom newI(TeXParser tp) {
				final RowAtom ra = new RowAtom(3);
				ra.add(Symbols.LEFTARROW, new SpaceAtom(TeXLength.Unit.EM, -0.180), Symbols.RIGHTARROW);
				ra.setShape(true);
				return new TypedAtom(TeXConstants.TYPE_RELATION, ra);
			}
		});
		map.put("Longleftrightarrow", new Command0A() {
			...
			public Atom newI(TeXParser tp) {
				final RowAtom ra = new RowAtom(3);
				ra.add(Symbols.BIG_LEFTARROW, new SpaceAtom(TeXLength.Unit.EM, -0.180), Symbols.BIG_RIGHTARROW);
				ra.setShape(true);
				return new TypedAtom(TeXConstants.TYPE_RELATION, ra);
			}
		});
		...
		map.put("idotsint", new Command0A() {
			...
			public Atom newI(TeXParser tp) {
				...
				final RowAtom ra = new RowAtom(integral, sa, cdots.changeType(TeXConstants.TYPE_INNER), sa, integral);
				ra.lookAtLastAtom = true;
				return ra.changeType(TeXConstants.TYPE_BIG_OPERATOR);
			}
		});
		...
		map.put("begin@eqnarray",
				new EnvArray.Begin("eqnarray", ArrayAtom.ARRAY,
						new ArrayOptions(3).addAlignment(TeXConstants.Align.RIGHT)
								.addAlignment(TeXConstants.Align.CENTER).addAlignment(TeXConstants.Align.LEFT)
								.close()));
		map.put("end@eqnarray", new EnvArray.End("eqnarray"));
		map.put("begin@split", new EnvArray.Begin("split", ArrayAtom.ARRAY, new ArrayOptions(2)
				.addAlignment(TeXConstants.Align.RIGHT).addAlignment(TeXConstants.Align.LEFT).close()));
		map.put("end@split", new EnvArray.End("split"));
		map.put("begin@cases",
				new EnvArray.Begin("cases", ArrayAtom.ARRAY,
		...
		map.put("smallfrowneq", new Command0A() {
			@Override
			public Atom newI(TeXParser tp) {
				final Atom at = new UnderOverAtom(Symbols.EQUALS, Symbols.SMALLFROWN,
		...
		map.put("frowneq", new Command0A() {
			@Override
			public Atom newI(TeXParser tp) {
				final Atom at = new UnderOverAtom(Symbols.EQUALS, Symbols.FROWN, TeXLength.getZero(), true, true);
				return at.changeType(TeXConstants.TYPE_RELATION);
			}
		});
		...
		map.put("dotminus", new Command0A() {
			@Override
			public Atom newI(TeXParser tp) {
				Atom at = new UnderOverAtom(Symbols.MINUS, Symbols.NORMALDOT, new TeXLength(TeXLength.Unit.EX, -0.4),
						false, true);
		...
		map.put("doteq", new Command0A() {
			@Override
			public Atom newI(TeXParser tp) {
				final Atom at = new UnderOverAtom(Symbols.EQUALS, Symbols.LDOTP, new TeXLength(TeXLength.Unit.MU, 3.7),
						false, true);
				return at.changeType(TeXConstants.TYPE_RELATION);
			}
		});
		map.put("cong", new Command0A() {
			@Override
			public Atom newI(TeXParser tp) {
				final VRowAtom vra = new VRowAtom(Symbols.SIM, new SpaceAtom(TeXLength.Unit.MU, 0., 1.5, 0.),
						Symbols.EQUALS);
		...
		map.put("end@math", new CommandMathStyles.CloseBracket(TeXConstants.Opener.BEGIN_MATH, TeXConstants.STYLE_TEXT,
		...
		map.put("textvisiblespace", new Command0A() {
			...
			public Atom newI(TeXParser tp) {
				tp.skipPureWhites();
				final Atom a = new HVruleAtom(null, new TeXLength(TeXLength.Unit.EX, 0.3), null, false);
				return new RowAtom(new SpaceAtom(TeXLength.Unit.EM, 0.06), a,
						new HVruleAtom(new TeXLength(TeXLength.Unit.EM, 0.3), null, null, true), a);
			}
		});
		...
		map.put("JLaTeXMath", new Command0A() {
			@Override
			public Atom newI(TeXParser tp) {
				return new RowAtom(new CharAtom('J', TextStyle.MATHBB, true), new LaTeXAtom(),
						new CharAtom('M', TextStyle.MATHNORMAL, true), new CharAtom('a', TextStyle.MATHNORMAL, true),
						new CharAtom('t', TextStyle.MATHNORMAL, true), new CharAtom('h', TextStyle.MATHNORMAL, true));
			}
		});
		...
		map.put("dotsi", new Command0A() {
			...
			public Atom newI(TeXParser tp) {
				...
				return new RowAtom(new SpaceAtom(TeXConstants.Muskip.NEGTHIN), ra.changeType(TeXConstants.TYPE_INNER));
			}
		});
