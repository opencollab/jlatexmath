...
public class HTMLCanvasContext {
	...
	public void image(int w, int h, float x, float y, int[] pixels) {
		...
		sb.append("await displayImage(").append(ctx).append(",").append(w).append(",").append(h).append(",").append(x)
				.append(",").append(y).append(",\"").append(b64).append("\")\n;");
	}
