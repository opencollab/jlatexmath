...
public class TeXLength {
    ...
    public static enum Unit {EM, // 1 em = the width of the capital 'M' in the current font
    ...
    public static double getLength(final String name, final TeXEnvironment env) {
