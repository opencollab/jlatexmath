...
public class JLMContext2d extends Context2d {
	...
	final public native void fillOpentype(JavaScriptObject path) /*-{
		...
		@org.scilab.forge.jlatexmath.web.font.opentype.OpentypeFontWrapper::drawPath(Lcom/google/gwt/core/client/JavaScriptObject;IILcom/google/gwt/canvas/client/Canvas;)(path, 0, 0, this);
	}-*/;
