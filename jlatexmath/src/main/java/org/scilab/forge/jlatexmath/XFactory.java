...
public class XFactory {
	...
	public static Box createLeftRightArrow(TeXEnvironment env, double width) {
		...
		return createExtension(env, left, leftLB, leftW, bodyLW, roundLW, right, rightLB, rightW, bodyRW, roundRW,
				width);
	}

	public static Box createExtension(TeXEnvironment env, CharBox left, double leftLB, double leftW, double bodyLW,
			double roundLW, CharBox right, double rightLB, double rightW, double bodyRW, double roundRW, double width) {
