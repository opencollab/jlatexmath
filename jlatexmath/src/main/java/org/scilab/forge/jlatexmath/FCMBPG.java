	...
	protected final void initMetrics() {
		...
		setInfo('\u0390', // char code: 912
				...
				new char[] { '\u03B3', '\u03B7', '\u03B8', '\u03BD', '\u03BF', '\u03C2', '\u03C3', '\u03C4', '\u03C7',
						'\u03D1' }, // kern codes
				new double[] { -0.032, -0.019, -0.019, -0.064, -0.032, -0.032, -0.032, -0.032, -0.032, -0.019 }, // kern
																													// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u0391', // char code: 913
				...
				new char[] { '\u0398', '\u039F', '\u03A4', '\u03A5', '\u03A6', '\u03A8', '\u03AB' }, // kern
																										// codes
				new double[] { -0.096, -0.096, -0.096, -0.16, -0.096, -0.141, -0.16 }, // kern
																						// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03AF', // char code: 943
				...
				new char[] { '\u03B3', '\u03B7', '\u03B8', '\u03BD', '\u03BF', '\u03C2', '\u03C3', '\u03C4', '\u03C7',
						'\u03D1' }, // kern codes
				new double[] { -0.032, -0.019, -0.031, -0.064, -0.032, -0.032, -0.032, -0.032, -0.032, -0.019 }, // kern
																													// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u03C4', // char code: 964
				...
				new char[] { '\u03AC', '\u03B1', '\u03BF', '\u03C9', '\u03CC', '\u03CE', '\u1F00', '\u1F01', '\u1F04',
						...
						'\u1FA7', '\u1FB2', '\u1FB4', '\u1FB6', '\u1FB7', '\u1FF2', '\u1FF4', '\u1FF6', '\u1FF7' }, // kern
																													// codes
				new double[] { -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032,
						-0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032,
						-0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032,
						-0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032, -0.032 }, // kern
																											// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
