...
public class SVGContext {
	...
	public SVGContext(final int width, final int height, final String fontBaseURL, final Color c,
			final BasicStroke stroke, final AffineTransform T) {
	...
	public String toString() {
		...
		s.append("<svg width=\"").append(width).append("\" height=\"").append(height)
	...
	public void fillRect(int a, int b, int c, int d) {
		makeG();
		sb.append("<rect x=\"").append(a).append("\" y=\"").append(b).append("\" width=\"").append(c)
				.append("\" height=\"").append(d).append("\" stroke=\"transparent\"/>\n");
	}
	...
	private void makeStroke() {
		sb.append("stroke-width=\"").append(stroke.getLineWidth()).append("\" stroke-miterlimit=\"")
				.append(stroke.getMiterLimit()).append("\" stroke-linejoin=\"");
	...
	private void makeG() {
		if (hasG) {
			...
			sb.append("<g stroke=\"").append(c).append("\" fill=\"").append(c).append("\" ");
			makeStroke();
			sb.append(">\n");
			hasG = false;
		}
